...
public class Texto extends AppCompatActivity {
    ...
    private String textoEstudo = "Contrary to popular belief, Lorem Ipsum is not simply random text. " +
    ...
    private TextView txtViewTextoEstudo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnQuizTexto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Texto.this, QuizActivity.class);
                startActivity(intent);
                finish();
            }
        });
